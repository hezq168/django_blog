    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.CharField(blank=True, default='', max_length=30, null=True, verbose_name='姓名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=100, verbose_name='用户邮箱')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='日期')),
                ('code_type', models.CharField(choices=[('reg', '注册'), ('reset', '找回密码')], default='reg', max_length=10, verbose_name='验证码类型')),
            ],
            options={
                'verbose_name': '邮箱验证码',
